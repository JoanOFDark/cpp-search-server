...
private:
    ...
    struct Query
    {
        ...
        // PlusMinusWords::PLUS_WORDS для сортировки плюс-слов, PlusMinusWords::MINUS_WORDS для сортировки минус-слов
        void SortUniq(PlusMinusWords pmw); //Не совсем понял как сделать один метод))
                                           //сделать одно объявление и две перегрузки?
